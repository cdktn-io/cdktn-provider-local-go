...
func (j *jsiiProxy_LocalProvider) AliasInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aliasInput",
...
func (j *jsiiProxy_LocalProvider) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_LocalProvider) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LocalProvider) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LocalProvider) MetaAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"metaAttributes",
...
func (j *jsiiProxy_LocalProvider) Node() constructs.Node {
...
func (j *jsiiProxy_LocalProvider) RawOverrides() interface{} {
...
func (j *jsiiProxy_LocalProvider) TerraformProviderSource() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LocalProvider) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Experimental.
func LocalProvider_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLocalProvider_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LocalProvider_IsTerraformProvider(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLocalProvider_IsTerraformProviderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LocalProvider) ResetAlias() {
	_jsii_.InvokeVoid(
		l,
		"resetAlias",
		nil, // no parameters
...
func (l *jsiiProxy_LocalProvider) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LocalProvider) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LocalProvider) ToMetadata() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LocalProvider) ToString() *string {
	var returns *string
...
func (l *jsiiProxy_LocalProvider) ToTerraform() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LocalProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
