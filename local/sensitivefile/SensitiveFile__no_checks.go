...
func (s *jsiiProxy_SensitiveFile) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (s *jsiiProxy_SensitiveFile) validateImportFromParameters(id *string) error {
	return nil
}
...
func (s *jsiiProxy_SensitiveFile) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	return nil
}
...
func (s *jsiiProxy_SensitiveFile) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	return nil
}

func validateSensitiveFile_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func validateSensitiveFile_IsTerraformElementParameters(x interface{}) error {
	return nil
}

func validateSensitiveFile_IsTerraformResourceParameters(x interface{}) error {
	return nil
}
