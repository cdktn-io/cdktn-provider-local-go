...
func (j *jsiiProxy_File) validateSetContentParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_File) validateSetFilePermissionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_File) validateSetSensitiveContentParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
