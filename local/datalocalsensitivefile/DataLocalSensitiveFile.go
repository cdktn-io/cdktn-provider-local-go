...
import (
	...
	"github.com/cdktn-io/cdktn-provider-local-go/local/v14/datalocalsensitivefile/internal"
...
func (j *jsiiProxy_DataLocalSensitiveFile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataLocalSensitiveFile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataLocalSensitiveFile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataLocalSensitiveFile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataLocalSensitiveFile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataLocalSensitiveFile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataLocalSensitiveFile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataLocalSensitiveFile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataLocalSensitiveFile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataLocalSensitiveFile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataLocalSensitiveFile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataLocalSensitiveFile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataLocalSensitiveFile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataLocalSensitiveFile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataLocalSensitiveFile) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataLocalSensitiveFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
