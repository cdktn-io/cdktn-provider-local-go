...
import (
	...
	"github.com/cdktn-io/cdktn-provider-local-go/local/v14/datalocalfile/internal"
...
func (j *jsiiProxy_DataLocalFile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataLocalFile) ContentBase64Sha256() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentBase64Sha256",
...
func (j *jsiiProxy_DataLocalFile) ContentBase64Sha512() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentBase64Sha512",
...
func (j *jsiiProxy_DataLocalFile) ContentMd5() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentMd5",
...
func (j *jsiiProxy_DataLocalFile) ContentSha1() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentSha1",
...
func (j *jsiiProxy_DataLocalFile) ContentSha256() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentSha256",
...
func (j *jsiiProxy_DataLocalFile) ContentSha512() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentSha512",
...
func (j *jsiiProxy_DataLocalFile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataLocalFile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataLocalFile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataLocalFile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataLocalFile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataLocalFile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataLocalFile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataLocalFile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataLocalFile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataLocalFile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataLocalFile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataLocalFile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataLocalFile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataLocalFile) ToHclTerraform() interface{} {
	var returns interface{}
